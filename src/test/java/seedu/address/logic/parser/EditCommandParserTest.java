...
public class EditCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        ...
        // invalid prefix being parsed as preamble
        assertParseFailure(parser, "tom i/ string", MESSAGE_INVALID_FORMAT);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_AMY + INVALID_EMAIL_DESC, Email.MESSAGE_CONSTRAINTS);
    ...
    @Test
    public void parse_editByIndexWithAllFieldsSpecified_success() {
        ...
        EditCommand expectedCommand = new EditCommand(targetIndex, DUMMY_NAME, descriptor);

        assertParseSuccess(parser, userInput, expectedCommand);
    }

    @Test
    public void parse_editByNameWithAllFieldsSpecified_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
        EditCommand expectedCommand = new EditCommand(null, targetName, descriptor);

        assertParseSuccess(parser, userInput, expectedCommand);
    }

    @Test
    public void parse_editByIndexWithSomeFieldsSpecified_success() {
    ...
    @Test
    public void parse_editByNameWithSomeFieldsSpecified_success() {
        String targetName = "Alice";
    ...
    @Test
    public void parse_editByIndexWithOneFieldSpecified_success() {
        // name
        ...
        expectedCommand = new EditCommand(targetIndex, DUMMY_NAME, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    @Test
    public void parse_editByNameWithOneFieldSpecified_success() {
        // name
        String targetName = "Alice";
        ...
        descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_AMY).build();
        expectedCommand = new EditCommand(null, targetName, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    @Test
    public void parse_editByIndexWithMultipleRepeatedFields_failure() {
    ...
    @Test
    public void parse_editByNameWithMultipleRepeatedFields_failure() {
        // More extensive testing of duplicate parameter detections is done in
        // AddCommandParserTest#parse_repeatedNonTagValue_failure()
    ...
    @Test
    public void parse_editByIndexWithResetTags_success() {
        Index targetIndex = INDEX_THIRD_PERSON;
    ...
    @Test
    public void parse_editByNameWithResetTags_success() {
        String targetName = "Alice";
